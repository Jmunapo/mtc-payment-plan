        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email"><?php echo $data[0]['reg_number']; ?></div>
            ...
            <div class="menu">
                <ul class="list">
                    <li class="header">STUDENT PORTAL</li>
                    <li >
                        <a href="index.php">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="pages/tables/jquery-datatable.html">History</a>
                            </li>
                            <li>
                                <a href="pages/tables/editable-table.html">Terms & Conditions</a>
                            </li>
                        </ul>
                    </li>
                    <li>
