...
class DBHelper
{
    ...
    public
    function  getDist($table, $where_column,$as)
    {
        $sql = "SELECT DISTINCT($where_column) AS $as FROM $table ";
	...
	public
    function  getDist2($table, $where_column,$as,$filter,$filter_value)
    {
        $sql = "SELECT DISTINCT($where_column) AS $as FROM $table WHERE $filter =  $filter_value";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
	...
	public
    function  getCountSum($where_column)
    {
        $sql = "SELECT price, SUM(tokens) AS popularity FROM payments WHERE payments.game = $where_column";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
     ...
     * @return array Returns an array of data fetched from the table
     */
    function getAscendingValues($table)
    {
     ...
     * At index 0 of the array put the table name and then you can insert your values at other indexes in the order of your table structure.
     ...
     */
    function getDetailsPass($table_name, $where_column1, $where_column2, $where_value1, $where_value2)
    {
        $sql = "SELECT * FROM $table_name WHERE $where_column1 = '$where_value1' && $where_column2 = '$where_value2'";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
	...
	//added  by Joe
	  function getDetails3($table_name, $where_column1, $where_column2, $where_column3, $where_value1, $where_value2, $where_value3)
    {
        $sql = "SELECT * FROM $table_name WHERE $where_column1 = '$where_value1' && $where_column2 = '$where_value2' && $where_column3 = '$where_value3'";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
    ...
    function getDetails4($table_name, $where_column1, $where_column2, $where_value1, $where_value2)
    {
        $sql = "SELECT * FROM $table_name WHERE $where_column1 = '$where_value1' || $where_column2 = '$where_value2'";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
    ...
    function updateResume($table_name, $set_column, $set_value, $where_column1, $where_value1, $where_column2, $where_value2, $where_column3, $where_value3,
                          $where_column4, $where_value4, $where_column5, $where_value5, $where_column6, $where_value6, $where_column7, $where_value7,
                          $where_column8, $where_value8, $where_column9, $where_value9, $where_column10, $where_value10, $where_column11, $where_value11,
                          $where_column12, $where_value12, $where_column13, $where_value13)

    {
        $sql = "UPDATE $table_name SET $set_column = '$set_value' WHERE $where_column1 ='$where_value1' && $where_column2 = '$where_value2' &&
                        $where_column3 = '$where_value3' && $where_column4 = '$where_value4' && $where_column5 = '$where_value5' && $where_column6 = '$where_value6' && $where_column7 = '$where_value7' &&
                        $where_column8 = '$where_value8' && $where_column9 = '$where_value9' && $where_column10 = '$where_value10' && $where_column11 = '$where_value11' &&
                        $where_column12 = '$where_value12' && $where_column13 = '$where_value13'";
    ...
    function getTableSize2($table_name, $column)
    {
	  ...
	  function searchDetails2($table_name, $where_column,$like_value,$filter,$filter_value)
    {
		$sql = "SELECT * FROM $table_name WHERE $where_column LIKE '%$like_value%' && $filter = '$filter_value'";
        $qry = mysqli_query($this->connectToServer(), $sql);
        $result = array();
