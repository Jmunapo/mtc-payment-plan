                                ...
                                if($status=='approved'){
                                 ...
                                 <div class="col-xs-12 ">
                                    ...
                                    ?>
                                     <div class="col-xs-12 ">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <button class="btn btn-primary waves-effect col-md-12 changcolor" data-type="prompt">DISAPPROVE</button>
                                    </div>
                               
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <button class="btn btn-primary waves-effect col-md-12 changcolor" data-type="ajax-loader">APPROVE</button>
                                    </div>
                                </div>
                                </div>
