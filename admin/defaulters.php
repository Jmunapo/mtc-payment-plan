    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../index.html">MTC PLAN ADMIN PANEL</a>
            </div>
                        ...
                        <div class="body">
                            ...
                            <div class="col-xs-12 ">
                               ...
                               <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="col-xs-12 ">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                        <button class="btn btn-primary waves-effect col-md-12" data-type="prompt">DISAPPROVE</button>
                                    </div>
                               
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <button class="btn btn-primary waves-effect col-md-12" data-type="ajax-loader">APPROVE</button>
                                    </div>
                                </div>
                                </div>
